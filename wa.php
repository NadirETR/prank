...
untuk ( $ a = 0 ; $ a < $ jumlah ; $ a ++ ) {
	...
	$ config [ ' header ' ] =  meledak ( " \ n " , " Host: m.bukalapak.com
Koneksi: tetap hidup
Panjang Konten: 134
